...
function DoubleArrow({ color, rotate }) {
    return (
        <svg style={rotate && {transform: `rotate(${rotate}deg)`}} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" enableBackground="new 0 0 32 32" version="1.1" viewBox="0 0 32 32" xmlSpace="preserve">

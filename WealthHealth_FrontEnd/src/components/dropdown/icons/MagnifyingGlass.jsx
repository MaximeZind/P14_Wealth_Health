...
function MagnifyingGlass({ color }) {
    return (
        <svg color={color} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="475.084px" height="475.084px" fill='rgb(177,196,108, 0.4)' viewBox="0 0 475.084 475.084" enableBackground="new 0 0 475.084 475.084" xmlSpace="preserve">
            <g>
